...
from clients.courses.courses_schema import (UpdateCourseRequestSchema, UpdateCourseResponseSchema, CourseSchema, GetCoursesResponseSchema,
...
def assert_create_course_response(request: CreateCourseRequestSchema, response: CreateCourseResponseSchema):
    ...
    assert_equal(str(response.course.created_by_user.id), request.created_by_user_id, name="created_by_user_id")
    assert_equal(str(response.course.preview_file.id), request.preview_file_id, name="preview_file_id")
